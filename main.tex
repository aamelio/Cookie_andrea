...
\begin{frame}{WTP within: valuations and quality attention by product}
  \hypertarget{main:wtp_within_attention}{}
  \hfill\hyperlink{app:wtp_within_attention_ratio}{\beamerbutton{Weight-ratio version}}
  \medskip
  \begin{columns}
    \column{0.5\textwidth}\centering Cookies\\[2pt]
...
\begin{frame}{Appendix: WTP within attention, weight-ratio version}
  \hypertarget{app:wtp_within_attention_ratio}{}
