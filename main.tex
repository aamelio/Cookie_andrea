...
\begin{frame}{WTP within: attention and implied premium take-up}
...
\begin{frame}{Observed vs.\ attention-predicted WTA\,$-$\,WTP gap}
...
\begin{frame}{Appendix}
  \src{LLM prompt (D3 App B).
  Fine-tuning LLM (next slide).}
\end{frame}
