...
\end{itemize}
\emph{High:} ``These cookies are delicious.''; ``Tate's is a premium brand.''; ``Soft and creamy.'' \quad \emph{Low:} ``Hard and bitter.''; ``Heavily processed.''
...
\end{itemize}
\emph{High:} ``Cookies like these are pricey.''; ``Overpriced in general.''; ``Premium products cost a lot.'' \quad \emph{Low:} ``Cookies are usually cheap.''; ``Affordable snack.''; ``Reasonably priced.''
\end{frame}
